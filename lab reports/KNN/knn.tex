...
\begin{enumerate}
  \item \textbf{准确率对比}：基于Mindspore实现的神经网络在CIFAR-10数据集上的准确率约为\textbf{53\%}，如图~\ref{add1} 所示，
...
\begin{figure}[htbp]
  \centering
  \includegraphics[scale=0.65]{figures/nn/loss_and_acc_mindspore.png}
  \caption{基于Mindspore实现的神经网络在CIFAR-10数据集上的Loss和Accuracy曲线}
  \label{add1}
\end{figure}

\begin{figure}[htbp]
  \centering
  \includegraphics[scale=0.65]{figures/nn/matrix_mindspore.png}
  \caption{基于Mindspore实现的神经网络在CIFAR-10数据集上的混淆矩阵}
  \label{add2}
\end{figure}
